...
# draw a blank rectangle as background of text
 canvas1.create_rectangle(30, 80, x-30, 100, fill="white", width=0) # no border
# draw text
 canvas1.create_text(x/2, 90, fill="black", font="courier 12", text=s)
...
button1 = Button(root, text='Convert', command=reallygetText)
